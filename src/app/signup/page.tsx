...
import { Wrench, Mail, Lock, User, AlertCircle, CheckCircle, Loader2 } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Vérifiez votre e-mail</h1>
          <p className="text-gray-400 text-sm leading-relaxed">
            Un lien de confirmation a été envoyé à <span className="text-white font-medium">{email}</span>.<br />
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Créez votre espace gratuitement</p>
        </div>
